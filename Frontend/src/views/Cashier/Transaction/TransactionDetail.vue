        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-green-50">
            <tr>
              ...
              <th
                class="px-6 py-3 text-center text-xs font-bold text-green-700 uppercase tracking-wider"
              >
                Actions
              </th>
            </tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                <div class="flex items-center justify-center space-x-3">
                  <button
                    ...
                    title="Tandai Lunas"
                    class="text-green-600 hover:text-green-800 transform hover:scale-110 transition duration-200 p-1 rounded-full hover:bg-green-100"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5"
                  ...
                  <button
                    ...
                    title="Lihat Detail"
                    class="text-blue-600 hover:text-blue-800 transform hover:scale-110 transition duration-200 p-1 rounded-full hover:bg-blue-100"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5"
